...
public class Users extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        userSearch.setText("Ingrese la cedula del usuario");
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
       try {
           ...
           String cedulasearch = userSearch.getText();
            
            if ("Ingrese la cedula del usuario".equals(cedulasearch)) {
            ...
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            dao.listar(cedulasearch).forEach((u) -> model.addRow(new Object[]{u.getId_user(),u.getCedula(),u.getDays(), u.getType(), u.getDay_of_arrival(), u.getRegistration_date() }));
    ...
    private void userSearchMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userSearchMousePressed
       if(userSearch.getText().equals("Ingrese la cedula del usuario")){
           userSearch.setText("");
    ...
    private void userSearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userSearchKeyTyped
        if(userSearch.getText().length() >= 10)
        {
        evt.consume();
        }
        ...
        if (userSearch.getText().trim().length() == 10) {
        evt.consume();
        }
