...
public class Reports extends javax.swing.JPanel {
    ...
    private void LoadLendings() {
        try {
            ...
            // Limpiamos tabla
            model.setRowCount(0);
            dao.listar("").forEach((u) -> model.addRow(new Object[]{u.getId_user(),u.getCedula(),u.getDays(), u.getType(), u.getDay_of_arrival(), u.getRegistration_date() }));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cedula", "Dias de hospedaje", "Tipo de hospedaje", "Fecha de llegada", "Fecha de registro"
            }
        ) {
